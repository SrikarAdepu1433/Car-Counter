...
video = cv2.VideoCapture("cars moving.mp4")
...
while True:
    ...
    for r in result:
        ...
        for box in boxes:
            ...
            if CurrentCLASS == "car" or CurrentCLASS == "motorbike" or CurrentCLASS == "truck" or CurrentCLASS == "bus" or CurrentCLASS == "bicycle" and conf > 0.3:
